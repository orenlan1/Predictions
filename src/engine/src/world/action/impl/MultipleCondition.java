...
public class MultipleCondition extends ConditionAction {
    ...
    public MultipleCondition(List<ConditionAction> conditions, String logic, EntityDefinition entityDefinition, List<Action> thenActions, List<Action> elseActions, SecondaryEntity secondaryEntity) {
