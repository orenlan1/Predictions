package components.details.rules.manager.rule;
...
public class RuleCardController {
    ...
    public void showAction(ActionDTO dto) throws Exception {
        URL actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/increase/increaseAndDecreaseActionDetails.fxml");
        FXMLLoader loader;
        GridPane actionCard;
        ...
        switch (type) {
            case "INCREASE":
            case "DECREASE":
                actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/increase/increaseAndDecreaseActionDetails.fxml");
                break;
            case "MULTIPLICATION":
            case "DIVISION":
                actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/calculation/calculationActionDetails.fxml");
                break;
            case "CONDITION":
                if (dto.getConditionActionDTO().isSingular())
                    actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/condition/singular/singleConditionActionDetails.fxml");
                else
                    actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/condition/multiple/multipleConditionActionDetails.fxml");
                break;
            case "SET":
                actionDetailsFXML = getClass().getResource("/components/details/rules/manager/action/set/setActionDetails.fxml");
                break;
            case "KILL":
        ...
        actionCard.getStylesheets().add("/components/details/rules/manager/action/action.css");
